...
class CompanyListCtrl {
    ...
    public function action_companyList() {
        ...
        if (isset($this->form->nazwa) && strlen($this->form->nazwa) > 0) {
            $search_params['nazwa[~]'] = $this->form->nazwa . '%'; // dodanie symbolu % zastępuje dowolny ciąg znaków na końcu
        }
        ...
        App::getSmarty()->assign('firma', $this->records);  // lista rekordów z bazy danych
